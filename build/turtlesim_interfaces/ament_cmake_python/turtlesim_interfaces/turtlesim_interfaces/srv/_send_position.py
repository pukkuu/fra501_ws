...
class Metaclass_SendPosition(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'turtlesim_interfaces.srv.SendPosition')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from turtlesim_interfaces.srv import _send_position
...
class SendPosition(metaclass=Metaclass_SendPosition):
    from turtlesim_interfaces.srv._send_position import SendPosition_Request as Request
    from turtlesim_interfaces.srv._send_position import SendPosition_Response as Response
