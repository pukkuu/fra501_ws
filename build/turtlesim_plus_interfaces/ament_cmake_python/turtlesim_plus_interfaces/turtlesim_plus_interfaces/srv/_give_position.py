...
class Metaclass_GivePosition(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'turtlesim_plus_interfaces.srv.GivePosition')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from turtlesim_plus_interfaces.srv import _give_position
...
class GivePosition(metaclass=Metaclass_GivePosition):
    from turtlesim_plus_interfaces.srv._give_position import GivePosition_Request as Request
    from turtlesim_plus_interfaces.srv._give_position import GivePosition_Response as Response
